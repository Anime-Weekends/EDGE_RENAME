...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
        ...
        InlineKeyboardButton('Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/Anime_Madbess'),
        InlineKeyboardButton('Sᴜᴩᴩᴏʀᴛ', url='https://t.me/Weebs_Madness')
    ], [
    ...
    if data == "start":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton('Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/Anime_Madness'),
                InlineKeyboardButton('Sᴜᴩᴩᴏʀᴛ', url='https://t.me/Weebs_Madness')
            ], [
                InlineKeyboardButton('Aʙᴏᴜᴛ', callback_data='about'),
                InlineKeyboardButton('Dᴏɴᴀᴛᴇ', callback_data='donate')
